...
<div class="flex flex-col items-center justify-center py-8">
    <h1 class="text-4xl font-bold mb-8 text-center">What is a Fumo?</h1>
    <div class="flex flex-col md:flex-row items-start gap-8 w-full max-w-3xl mb-6 px-4 md:px-0">
        <div class="flex-1">
    ...
    <h2 class="text-2xl md:text-3xl font-semibold mb-2 text-center">These plushies have the following qualities:</h2>
    <ul class="list-disc pl-6 text-lg mb-6 text-left max-w-2xl px-4 md:px-0">
    ...
    <div class="max-w-3xl mb-6 px-4 md:px-0">
        <p class="text-lg mb-2">
    ...
    <div class="flex flex-col items-center mb-6 px-4 md:px-0">
    ...
    <div class="flex flex-col md:flex-row justify-center items-center gap-4 md:gap-8 mb-8 w-full px-4 md:px-0">
        <a href="#" class="border px-6 py-3 rounded text-lg hover:bg-gray-100 mb-2 md:mb-0 w-full md:w-auto text-center">Fumo Origins</a>
        <a href="#" class="border px-6 py-3 rounded text-lg hover:bg-gray-100 w-full md:w-auto text-center">How to get Fumos</a>
    </div>
    
</div>

<div class="flex justify-center mb-8 px-4 md:px-0">
    <a href="{{ route('home') }}" class="border px-8 py-3 rounded text-lg hover:bg-gray-100 w-full md:w-auto text-center">Back Home</a>
</div>
@endsection
